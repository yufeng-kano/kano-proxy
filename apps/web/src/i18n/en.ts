...
export const en = {
  ...
  "overview.stat.requests": "Requests",
  "overview.stat.tokens": "Tokens",
  "overview.stat.cacheRate": "Cache hit rate",
  "overview.stat.errors": "Errors",
  "overview.stat.latency": "Avg latency",
  "overview.stat.cacheCoverage": "Across {known} of {total} requests",
  "overview.stat.cacheNone": "No cache activity yet",
  "overview.stat.errorRate": "{rate} of all requests",
  "overview.chart.title": "Activity",
  "overview.chart.tokens": "Tokens",
  "overview.chart.cacheRate": "Cache rate",
  "overview.chart.view": "Chart",
  "overview.chart.showTable": "Table",
  "overview.chart.showChart": "Chart",
  "overview.chart.other": "Other",
  "overview.chart.noCacheData": "No cache activity in this range",
  "overview.chart.emptyBucket": "No activity",
  "overview.chart.total": "Total",
  "overview.chart.requests_one": "{count} request",
  "overview.chart.requests_other": "{count} requests",
  "overview.chart.cached": "{value} cached",
  "overview.chart.completion": "{value} output",
  "overview.chart.tokensTitle": "Tokens per model over time",
  "overview.chart.cacheRateTitle": "Cache hit rate per model over time",
  "overview.chart.tokensDesc":
    "Grouped column chart of tokens per time bucket, one column per model ({models} shown). {tokens} tokens and {rate} cache hit rate over the period. Switch to the table view for exact values.",
  "overview.chart.cacheRateDesc":
    "Line chart of cache hit rate per time bucket, one line per model ({models} shown), on a 0 to 100 percent axis. {rate} cache hit rate over the period. A bucket with no cache activity is a gap in the line, not a zero. Switch to the table view for exact values.",
  "overview.chart.bucketAria": "{when}: {detail}",
  "overview.chart.bucketNoData": "no activity",
  "overview.chart.modelTokens": "{model} {value} tokens",
  "overview.chart.modelRate": "{model} {value}",
  "overview.chart.modelNoRate": "{model} no cache activity",
  "overview.table.time": "Time",
  "overview.table.total": "Total",
  "overview.table.requests": "Requests",
  "overview.models.title": "By model",
  "overview.models.subtitle": "Highest usage first",
