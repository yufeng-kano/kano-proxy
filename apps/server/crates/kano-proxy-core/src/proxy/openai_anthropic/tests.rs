//! Converter cases. Streaming cases feed the converters on awkward chunk boundaries, so
//! event names and JSON payloads have to survive split reads.
...
// ---------------------------------------------------------------------------
// Converter flow control and line bounds
// ---------------------------------------------------------------------------
