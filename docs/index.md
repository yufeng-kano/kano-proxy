...
| [local-agent.md](./local-agent.md) | **Design draft.** CLI providers: `kano-proxy` CLI (device login, Rust/ratatui) + Durable Object reverse tunnel exposing local LLMs as first-class providers |
