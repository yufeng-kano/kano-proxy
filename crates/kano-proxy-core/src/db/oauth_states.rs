...
//! Google sign-in (`kind = 'google'`, apps/api/src/auth/google.ts) and a provider login
//! (`kind = 'provider'`, apps/api/src/routes/providers.ts). Rows expire in 15 minutes and are
