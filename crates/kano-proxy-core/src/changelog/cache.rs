//! Release-notes cache and the GitHub Releases fetch (apps/api/src/changelog/cache.ts plus
//! the upstream call `apps/api/src/routes/changelog.ts` makes, docs/admin-ui.md § Changelog).
//!
