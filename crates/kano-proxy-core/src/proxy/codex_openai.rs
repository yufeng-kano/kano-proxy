//! Codex Responses SSE → OpenAI Chat Completions (apps/api/src/proxy/codex_openai.ts,
//! docs/providers.md § Codex). The stream converter emits one Chat chunk per upstream
